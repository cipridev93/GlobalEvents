    ...
    public class ServiceBusListener : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            subscriptionClient = new SubscriptionClient(configuration.GetValue<string>("ServiceBusConnectionString"), 
                configuration.GetValue<string>("PriceUpdatedMessageTopic"), configuration.GetValue<string>("subscriptionName"));
        ...
        private async Task ProcessMessageAsync(Message message, CancellationToken token)
        {
            ...
            // It indicates to the broker that the message has been successfully processed and the message is removed from the queue or subscription.
